...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Targettype'), ['action' => 'edit', $targettype->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Targettype'), ['action' => 'delete', $targettype->id], ['confirm' => __('Are you sure you want to delete # {0}?', $targettype->id)]) ?> </li>
...
<div class="targettype view large-9 medium-8 columns content">
    <h3><?= h($targettype->name) ?></h3>
    ...
    <div class="row">
        ...
        <?= $this->Text->autoParagraph(h($targettype->description)); ?>
    </div>
    <div class="related">
        <h4><?= __('Related Example') ?></h4>
        <?php if (!empty($targettype->example)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($targettype->example as $example): ?>
            <tr>
                <td><?= h($example->id) ?></td>
    ...
    <div class="related">
        ...
        <?php if (!empty($targettype->lesson)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
            ...
            <?php foreach ($targettype->lesson as $lesson): ?>
            <tr>
                <td><?= h($lesson->id) ?></td>
    ...
    <div class="related">
        ...
        <?php if (!empty($targettype->questionbank)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Topic Id') ?></th>
            ...
            <?php foreach ($targettype->questionbank as $questionbank): ?>
            <tr>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($targettype->quiz as $quiz): ?>
            <tr>
                <td><?= h($quiz->id) ?></td>
