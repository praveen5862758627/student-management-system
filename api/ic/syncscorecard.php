...
$resultlesson = $post->getallcourses($userid, $moodleid);
// Get row count
...
if ($numlesson > 0) {
    ...
    while ($row = $resultlesson->fetch(PDO::FETCH_ASSOC)) {
        ...
        $post_item = array(
            ...
            'link' => html_entity_decode("<a style='cursor:pointer;color:blue' onclick='showrelatedexams($id)'>Show related Exams</a>")
        );
