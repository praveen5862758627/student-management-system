...
$resultlesson = $post->semestercompsstudent($prod_cat->id);
// Get row count
...
if ($numlesson > 0) {
    ...
    while ($row = $resultlesson->fetch(PDO::FETCH_ASSOC)) {
        ...
        $post_item = array(
            ...
            'topic_code' => html_entity_decode($topic_code),
            'lesson_code' => html_entity_decode($lesson_code),
            'level_code' => html_entity_decode($level_code),
