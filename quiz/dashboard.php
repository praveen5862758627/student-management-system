...
//var_dump($json_data11);
      ...
      $answersfq = $json_data11['question'];
		  ...
		  if($_SESSION['shuffle_question'] == 0)
		  {
                                        
		  }
		  else if($_SESSION['shuffle_question'] == 1)
		  {
			  shuffle($answersfq);
		  }
		  else
...
if($_SESSION['shuffle_answer'] == 0)
		  {
                                        
		  }
		  else if($_SESSION['shuffle_answer'] == 1)
		  {
			  shuffle($answersf);
		  }		
else
