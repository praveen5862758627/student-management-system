...
$string = file_get_contents($quizurlroot, false, stream_context_create($arrContextOptions));
...
//var_dump($json_data["shuffle_question"]);



//var_dump($json_data["shuffle_question"]);
if( isset( $json_data['shuffle_question'] ) ){

	$_SESSION['shuffle_question'] = 0;

}
else
{
	$_SESSION['shuffle_question'] = 1;
}

if( isset( $json_data['shuffle_answer'] ) ){


$_SESSION['shuffle_answer'] = 0;
}
else
{
	$_SESSION['shuffle_answer'] = 1;
}
...
.ml-lg-5, .mx-lg-5
{
 ...
 <?php if($json_data['show_description'] == 1){?>
        <!-- Card -->
        <div class="card">
          ...
          <div class="card-body">
            <div class="media">
			 ...
			 <?php echo $json_data['quiz_description']; ?>
              </div>
