...
<?= $this->Form->create($moduletarget,array('class'=>'border border-light p-5')) ?>
    <fieldset>
        <legend><?= __('Edit Moduletarget') ?></legend>
        <?php
            echo $this->Form->control('modulecode',array('class'=>'form-control mb-4','label'=>'Module Code:','placeholder'=>"Module Code"));
            echo $this->Form->control('targetcode',array('class'=>'form-control mb-4','label'=>'Target Code:','placeholder'=>"Target Code"));
            echo $this->Form->control('targetname',array('class'=>'form-control mb-4','label'=>'Target Name:','placeholder'=>"Target Name"));
        ?>
    </fieldset>
