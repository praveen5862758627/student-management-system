...
<body class="grey lighten-3">
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        ...
        <a href="/semesters" class="list-group-item  active list-group-item-action waves-effect">
          <i class="fas fa-table mr-3"></i>Semesters</a>
  ...
  <main class="pt-5 mx-lg-5">
    ...
    <h3><?= __('Semesters') ?><?= $this->Html->link(__('Add '), ['action' => '../semesters/add'],['class'=>'btn btn-primary']) ?></h3>
