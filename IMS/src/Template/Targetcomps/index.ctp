...
<body class="grey lighten-3">
  ...
  <main class="pt-5 mx-lg-5">
    ...
    <h3><?= __('Targetcomps') ?><?= $this->Html->link(__('Add '), ['action' => '../targetcomps/add'],['class'=>'btn btn-primary']) ?></h3>
...
<table id="dtMaterialDesignExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
			  ...
			  $target_id = $notication['target_id'];
			 
			  
			  ?>
			   <td><?php echo $notication['id']; ?></td>
			   
                <td><?php echo $this->Custom->targetnamenbw($target_id); ?></td>
				 
                <td><?php echo $notication['targetcode']; ?></td>
               
                    <td><?php echo $notication['competency_code']; ?></td> 
					   <td><?php echo $notication['level']; ?></td> 
