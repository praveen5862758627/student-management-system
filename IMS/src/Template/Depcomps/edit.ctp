...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $depcomp->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $depcomp->id)]
            )
        ?></li>
...
<div class="depcomps form large-9 medium-8 columns content">
    <?= $this->Form->create($depcomp) ?>
    <fieldset>
        <legend><?= __('Edit Depcomp') ?></legend>
        <?php
            echo $this->Form->control('dep_id', ['options' => $deps]);
