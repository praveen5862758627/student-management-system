...
<body class="grey lighten-3">
  ...
  <main class="pt-5 mx-lg-5">
    ...
    <h3><?= __('Target') ?><?= $this->Html->link(__('Add '), ['action' => '../target/add'],['class'=>'btn btn-primary']) ?></h3>
			  ...
			  ?>
			   <td><?php echo $notication['id']; ?></td>
                ...
                <td><?php echo $notication['name']; ?></td>
                    ...
                    <td><?php echo $notication['companycode']; ?></td> 
					   <td><?php echo $notication['cutoff']; ?></td> 
					      <td><?php echo $notication['minage']; ?></td> 
						     <td><?php echo $notication['maxage']; ?></td> 
							    <td><?php echo $notication['month_approximate']; ?></td> 
								   <td><?php echo $notication['year']; ?></td> 
