...
{
	//alert(a);
	   var url             =   'https://www.odinlearning.in/API/cmd/level.php';
...
function leaveChange(a)
{
    ...
    var url             =   'https://www.odinlearning.in/API/cmd/lesson.php';
    // call subcategory ajax here 
    $.ajax({
                   type:"POST",
                   url:url,
...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $semestercomp->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $semestercomp->id)]
            )
        ?></li>
...
<div class="semestercomps form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Semestercomp') ?></legend>
