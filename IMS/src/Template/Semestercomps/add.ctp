...
function getlevels(a){
    ...
    <fieldset>
        <legend><?= __('Add Semestercomp/Modulecomp') ?></legend>
        <?php
        ...
        ?>
		 ...
		 <label >Topic code :*</label>
			<select name="topic_code"  id="topic_code-id" class="mdb-select form-control mb-4" required onchange="leaveChange(this.value)">
		...
		<select name="level_code" id="level_code" required  class="mdb-select form-control mb-4" >
