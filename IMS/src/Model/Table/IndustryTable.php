...
class IndustryTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('numpeopleglobal')
			  ->maxLength('numpeopleglobal', 200)
            ->requirePresence('numpeopleglobal', 'create')
            ->allowEmptyString('numpeopleglobal', false);

        $validator
            ->scalar('numpeopleindia')
			  ->maxLength('numpeopleindia', 200)
            ->requirePresence('numpeopleindia', 'create')
            ->allowEmptyString('numpeopleindia', false);
