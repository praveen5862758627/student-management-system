...
class IndustryFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'numpeopleglobal' => ['type' => 'integer', 'length' => 50, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'numpeopleindia' => ['type' => 'integer', 'length' => 50, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'numpeopleglobal' => 1,
                'numpeopleindia' => 1,
                'created' => '2019-02-21 06:16:44',
                'modified' => '2019-02-21 06:16:44'
            ],
        ];
        parent::init();
    }
