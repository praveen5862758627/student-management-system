 ...
 *
 */
class QuestionbankFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'program' => ['type' => 'string', 'length' => 250, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-02-20 09:23:19',
                'modified' => '2019-02-20 09:23:19'
            ],
        ];
        parent::init();
    }
