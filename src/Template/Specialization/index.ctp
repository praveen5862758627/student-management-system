 ...
 * @var \App\Model\Entity\Specialization[]|\Cake\Collection\CollectionInterface $specialization
 */
?>
...
<div class="specialization index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($specialization as $specialization): ?>
            <tr>
