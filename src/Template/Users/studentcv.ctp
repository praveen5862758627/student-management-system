        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="media ml-3">
              <img class="d-flex mr-3 z-depth-1" src="https://<?php echo $keycode1; ?>api.odinlearning.in/upload/<?= $photoname; ?>" alt="User" width="150px" height="150px">
