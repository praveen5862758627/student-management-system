...
.fixed-sn main {
 ...
 <li>
				...
				<li>
                    <a href="#" onclick="dispalyresouvcesgallerty();return false;" > <i class="fas fa-file-alt"></i>
					Resources</a>
                </li>
...
this.blur();    this.focus();  }"> -->
 ...
 <?php if(Configure::read('Topmenu.purchase') == 1) { ?>
                        ...
                        <a style="margin-right: -149px;" href="https://sites.google.com/xlanz.com/odin-help" target="_blank" class="collapsible-header waves-effect" data-toggle="tooltip" data-placement="bottom"
                           title="View Documentation" ><i class="w-fa fas fa-question-circle" style="font-size: 39px;
                                                                                                                                                                     color: white;
                                                                                                                                                                     padding-top: 8px;"></i></a>
							 <?php } ?>	

	 <a style="margin-right:21px" href="#" class="collapsible-header waves-effect" data-toggle="tooltip" data-placement="bottom"
                           title="Resources" onclick='dispalyresouvcesgallerty()'><i class="w-fa fas fa-file-alt" style="font-size: 39px;
                                                                              color: white;
                                                                              padding-top: 8px;"></i></a>							 
						 ...
						 <a style="margin-right:63px" href="#" class="collapsible-header waves-effect" data-toggle="tooltip" data-placement="bottom"
						...
						<a style="margin-right: -78px;" href="#" class="collapsible-header waves-effect" data-toggle="tooltip" data-placement="bottom"
...
<?php } ?>  
  ...
  <?= $this->Form->end(); ?>
            ...
            <?= $this->Form->create($user, ['type' => 'file','onsubmit'=>'return validatephoinenum()']); ?>
                                                ...
                                                <div class="row">
												 <?php include('requiredfields.ctp'); ?>
                                                    <!-- First column -->
													<?php if(Configure::read('Myprofile_personal.firstname') == 1) { ?>
                                                    <div class="col-md-6">
						 ...
						 <?= $this->Form->control('fname' ,array('label' => false,'class' => 'form-control' ,'id' => 'inputName', $required1)); ?>
													...
													<?php } ?>
	<?php if(Configure::read('Myprofile_personal.lastname') == 1) { ?>
                                                    <!-- Second column -->
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
	...
	<?php } ?>
	<?php if(Configure::read('Myprofile_personal.gender') == 1) { ?>
                                                    <!-- First column -->
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
	...
	<?php } ?>
                   	<?php if(Configure::read('Myprofile_personal.dob') == 1) { ?>
					<!-- Second column -->
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
					...
					<?php } ?>
	<?php if(Configure::read('Myprofile_personal.category') == 1) { ?>
                                                    <!-- First column -->
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
	...
	<?php } ?>
		<?php if(Configure::read('Myprofile_personal.nationality') == 1) { ?>
	...
	$required6
		...
		<?php } ?>
			<?php if(Configure::read('Myprofile_personal.address1') == 1) { ?>
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">



						 <?= $this->Form->control('address',array('data-toggle'=>"tooltip" ,'data-placement'=>"top",
  'title'=>"Address is needed for invoicing",'label' => false,'class' => 'md-textarea form-control','id'=>'addstu',$required7  , 'rows'=>'3')); ?>
			...
			<?php } ?>
				...
				<?php if(Configure::read('Myprofile_personal.address2') == 1) { ?>
						    ...
						    <?= $this->Form->control('address2',array('data-toggle'=>"tooltip" ,'data-placement'=>"top",
  'title'=>"Address is needed for invoicing",'label' => false,'class' => 'md-textarea form-control','id'=>'addstu1', 'rows'=>'3')); ?>
				...
				<?php } ?>
					<?php if(Configure::read('Myprofile_personal.country') == 1) { ?>
...
<?php } ?>
													...
													<?php } ?>
														<?php if(Configure::read('Myprofile_personal.state') == 1) { ?>
                                                    <!-- First column -->
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
 ...
 <?php } ?>
														...
														<?php } ?>
															<?php if(Configure::read('Myprofile_personal.city') == 1) { ?>
						 ...
						 <?= $this->Form->control('city',array('type'=>'text','id'=>'citystudent','label' =>false,'class' => 'form-control',$required10)); ?>
															...
															<?php } ?>
																<?php if(Configure::read('Myprofile_personal.zipcode') == 1) { ?>
	...
	<?php /*} */?>
                                                    ...
                                                    <!-- Second column -->
	<?php if(Configure::read('Myprofile_personal.email_alternate') == 1) { ?>
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
	...
	<?php } ?>
				      ...
				      <?= $this->Form->control('userroles_id', ['type' => 'hidden','value' => $usersrole]);  ?>
                                                ...
                                                <!-- Third row -->
                                              	<?php if(Configure::read('Myprofile_personal.phone_primary') == 1) { ?>
					  ...
					  <?= $this->Form->control('phonenumber',array('label' => false,'onkeypress'=>'return isNumber(event)','id'=>'phpnenumbeforstude','onInput'=>'checkLength(10,this)','class' => 'form-control',$required12 )); ?>
												...
												<?php } ?>
                                                    <!-- First column -->
														<?php if(Configure::read('Myprofile_personal.phone_alternate') == 1) { ?>
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
...
<!-- Material inline 2 -->
<div class="form-check form-check-inline" id="bsdabvdsjnvfaf">
...
<?php } ?>
					    ...
					    <?php /* $this->Form->control('nationality',array('label' => false,'class' => 'form-control' ,'id' => 'nationality','required'=>'required')); */?>
                                                ...
                                                <!-- First row -->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
                                                    		 	  	<?=	
				 $this->Form->input('digitaltransformation', array(
	...
	'required' => 'required'
					    ...
					    <?php /* $this->Form->control('nationality',array('label' => false,'class' => 'form-control' ,'id' => 'nationality','required'=>'required')); */?>
                                                            ...
                                                            <label for="digitaltransformation" class="active"> Are you involved in a digital transformation project?	 <span style="color:red;">*</span></label>
                                                    ...
                                                    <div class="col-md-6">
													   <div class="md-form mb-0">
                                                    		 	  	<?=	
				 $this->Form->input('workindustry', array(
    'options' => array('Yes'=>'Yes','No'=>'No'),
    'type' => 'select',
    'empty' => 'Select an option',
     'label' => false,
	...
	'required' => 'required'
					    ...
					    <?php /* $this->Form->control('nationality',array('label' => false,'class' => 'form-control' ,'id' => 'nationality','required'=>'required')); */?>
                                                            ...
                                                            <label for="workindustry" class="active"> Have you worked in these provisions before MOM, IC, Senior Mgt	 <span style="color:red;">*</span></label>
                                                ...
                                                <!-- First row -->
                                                    ...
                                                    <div class="col-md-12">
													 ...
													 <div class="md-form mb-0">
                                                    		 	  		<?=	
				 $this->Form->input('dtprojects', array(
    'options' => array('Yes'=>'Yes','No'=>'No'),
    'type' => 'select',
    'empty' => 'Select an option',
     'label' => false,
	...
	'required' => 'required'
					    ...
					    <?php /* $this->Form->control('nationality',array('label' => false,'class' => 'form-control' ,'id' => 'nationality','required'=>'required')); */?>
                                                            ...
                                                            <label for="dtprojects" class="active">Do you see yourself or your company involved in a DT project in the near future?	 <span style="color:red;">*</span></label>
				 ...
				 <?php } ?>
											...
											<?php if(Configure::read('Academic.sslc_show') == 1) {?>
                                                <!-- Card -->
  ...
  <?= $this->Form->end(); ?> 
	...
	<?php if(Configure::read('Academic.puc_show') == 1) {?>
  ...
  <?= $this->Form->end(); ?> 
	...
	<?php if(Configure::read('Academic.graduation_institute_field') == 1) { ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="md-form form-sm mb-0">
                                                                    <input type="text" id="universitynameugpg1" class="form-control form-control-sm" name="universityname" value="<?php echo $universityname; ?>" <?php echo $required13; ?>>
                                                                    <label for="form6" class="active">Institution/University Name<?php echo $mandatory13; ?></label>
                                                                </div>
...
<?php } ?>
                                                        ...
                                                        <!-- Grid row -->
                                                        <div class="row">
															<?php if(Configure::read('Academic.graduation_stream') == 1) { ?>

                                                            <!-- Grid column -->
                                                            <div class="col-md-6">

                                                                <div class="md-form form-sm mb-0">
                                                                    <select class="mdb-select md-form" searchable="Search here.." onchange="leaveChange(this.value)" name="stream" id="boarderwwfsfs1" <?php echo $required14; ?>>
...
<?php } ?>
                                                                    ...
                                                                    <label for="boarderwwfsfs" class="active" style="    margin-top: -23px;
                                                                           font-size: 13px;
                                                                           left: 0;" >Stream<?php echo $mandatory14; ?></label>
															...
															<?php } ?>
																...
																<?php if(Configure::read('Academic.graduation_specialization') == 1) { ?>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="md-form form-sm mb-0">
                                                                    ...
                                                                    <select class="mdb-select md-form" searchable="Search here.." id="loadugsepcilaization1" name="specialization" id="boargfgderwwfsfs" <?php echo $required15; ?>>
 ...
 <?php } ?>
                                                                    ...
                                                                    <label for="boargfgderwwfsfs" class="active" style="    margin-top: -23px;
                                                                           font-size: 13px;
                                                                           left: 0;" >Specialization<?php echo $mandatory15; ?></label>
														...
														<?php if(Configure::read('Academic.graduation_regno') == 1) { ?>

                                                            <!-- Grid column -->
                                                            <div class="col-md-4">

                                                                <div class="md-form form-sm mb-0">
                                                                    <input type="text" id="regnougpg1" class="form-control form-control-sm" name="regno" value="<?php echo $regnoug; ?>" <?php echo $required16; ?>>
                                                                    <label for="form5" class="active">Registration No.<?php echo $mandatory16; ?></label>
                                                                </div>
														...
														<?php } ?>
															...
															<?php if(Configure::read('Academic.graduation_joining_year') == 1) { ?>

                                                            <!-- Grid column -->
                                                            <div class="col-md-4">

                                                                <div class="md-form form-sm mb-0">
                                                                    <input type="text" id="yearjoiningugpg1" class="form-control form-control-sm" name="yearjoining" value="<?php echo $yearjoining; ?>" <?php echo $required17; ?> onkeypress="return isNumber(event)" onInput="checkLength(4,this)">
                                                                    <label for="form5" class="active">Year of Joining<?php echo $mandatory17; ?></label>
                                                                </div>
                                                            ...
                                                            <!-- Grid column -->
                                                            <!-- Grid column -->
															<?php if(Configure::read('Academic.graduation_passout_year') == 1) { ?>
                                                            <div class="col-md-4">

                                                                <div class="md-form form-sm mb-0">
                                                                    <input type="text" id="yearpassoutugpg1" class="form-control form-control-sm" name="yearpassout" value="<?php echo $yearpassout; ?>" <?php echo $required18; ?>   onkeypress="return isNumber(event)" onInput="checkLength(4,this)">
                                                                    <label for="form5" class="active">Year of Passout<?php echo $mandatory18; ?></label>
                                                                </div>
                                                        ...
                                                        <!-- Grid row -->
<?php if(Configure::read('Academic.graduation_course_duration') == 1) { ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="md-form form-sm mb-0">
                                                                    ...
                                                                    <select class="mdb-select md-form" searchable="Search here.." name="courseduration" id="boadfdgfrdfsfs1" <?php echo $required19; ?>>
                                                                    ...
                                                                    <label for="boadfdgfrdfsfs" class="active" style="    margin-top: -23px;
                                                                           font-size: 13px;
                                                                           left: 0;" >Course duration <?php echo $mandatory19; ?></label>  
                                                                </div>
                                                        ...
                                                        <!-- Grid row -->
<?php } ?>
<?php if(Configure::read('Academic.graduation_semwise_marks') == 1) { ?>
                                                        <!-- Grid row -->
                                                        <div class="row">
...
(<span id="getvaluesp2"><?php echo number_format((float)$teamwork * 100, 2, '.', ''); ?></span>%)</label>
  ...
  <div class="col-md-6">
   ...
   <?php  } ?>
                  ...
                  <!-- Second row -->
				<?php if(Configure::read('MyersBriggs.test1') == 1 ) {?>

        <?php if($myersbriggs == '0' ) { ?>
		<div id="loadimgss"></div>
<button type="button" class="btn " onClick="evaluatemypersoanlity()" id="eveabriges" >Evaluate your personality type - Test1</button>
		<?php } else { ?>
...
<button type="button" class="btn " onClick="evaluatemypersoanlity()" id="eveabriges" style="display:none;" >Evaluate your personality type - Test 1</button>
		<div id="loadimgss"></div>
				<?php } } ?>
		
		<?php if(Configure::read('MyersBriggs.test2') == 1 ) {?>
		
		<button type="button" class="btn " onClick="evaluatemypersoanlitytest2()" id="eveabrigestest2" style="" >Evaluate your personality type - Test2</button>
...
<?php } ?>
	...
	<?php   foreach($getpaymentdetails as $det) {   ?>
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <thead class="tableheadernmhc" style="color: white;">
                                                        <tr >
                                                            <th colspan="2">
...
<?php include('modalboxedpersonlaitytest2.ctp'); ?> 
