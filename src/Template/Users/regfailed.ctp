...
<html lang="en">
  <head>
    ...
    <title>Registeration Fail - Odin Connect</title>
  </head>
  <body>
    ...
    <div class="container-fluid" id="ocregisterfail">
      <div class="row" id="oclogVrow">
          ...
          <div class="col-md-7 text-left" id="oclogcol031">
              ...
              <p>
                  ...
                  For some reason, your registration was not successful. Please try again or contact us at info@odinlearning.com or +98450 98450 on WhatsApp. <br><br><br><br><br><br>

              </p>

            
 <a class="btn" href="/users/Register" role="button">TRY REGISTRATION AGAIN</a>
