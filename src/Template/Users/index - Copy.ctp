...
<!--<a type="button" class="btn btn-default pull-right" onclick="alertforuser()" href="<?php echo Configure::read('MyConf.weburlmainsite');?>events/synctocalendar/<?php echo $userid; ?>" >Sync to Calendar</a>
                                        --><?php } ?>
...
<div class="table-responsive">
                    ...
                    <div id="addtargets" style="display:none" >
                        <div class="modal-body"  >
                            ...
                            <!--<button type="button" class="btn btn-default pull-right" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>users/jobfilters","My Filters")'>My Filters </button>-->
		...
		<br />
		 ...
		 <div class="table-responsive">
                                        <table class="table table-bordered table-striped">
											...
											<tr class="odd gradeX">
                                                    <td>Module 1/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>razor/prod1.php ","Module 1/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 2/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>razor/prod1.php ","Module 2/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 3/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>razor/prod1.php ","Module 3/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 4/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>razor/prod1.php ","Module 4/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 5/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>razor/prod1.php ","Module 5/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 6/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>razor/prod1.php ","Module 6/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 7/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>razor/prod1.php ","Module 7/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 8/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("<?php echo Configure::read('MyConf.weburlmainsite');?>razor/prod1.php ","Module 8/8")'  style="background-color:#FD8401" >Buy now</button></td>
            ...
            <div class="modal-dialog" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     <!--   <button type="reset" class="btn btn-default" onclick='redirecturlsstudent1("<?php echo Configure::read('MyConf.weburlmainsite');?>institutecalendar", "Event Management")'> Event Management</button>-->
...
<?php if($usersrole == 2) { ?>
					 ...
					 <button type="button"  style="position: absolute;left: 384px;top: 5px;" class="btn btn-primary" onclick='redirecturlsstudent1("<?php echo Configure::read('MyConf.weburlmainsite');?>userdashboard/scoreanalysis/index.php?id=<?php echo $userid; ?>","Score Analysis")'>Score Analysis</button>
