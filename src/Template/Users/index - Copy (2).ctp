...
.fixed-sn main {
    ...
    margin-top: -6px;
            ...
            <ul class="list-unstyled components">
					...
					<?php if($usersrole == 3) { ?>
                        <li>
                            <a href="#" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/users/addga","Create Users")' >Create Users</a>
                        </li>
                        <li>
                            <a href="#" onclick='openmodalbox1("Student" , "");return false;' >Manage Users</a>
                        </li>
							<li>
                            <a href="#" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/Studentgroup/add","Create a Group")'   >Create a Group</a>
                        </li>
							<li>
                            <a href="#" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/Studentgroup","Manage Groups")'   >Manage Groups</a>
                        </li>
						    <li>
                            <a href="#" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/users/addga","Create Group Administrator")' >Create Administrator</a>
                        </li>
						<li>
                            <a href="#" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/users/gausers","Manage Group Administrators")' >Manage Administrators</a>
                        </li>
						...
						<li>
                            <a href="#" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/Studentgroup","Group Management")' >View Users in Group</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu1110001">
                        <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')"> View Speaking Engagements</a>
                        </li>
                        <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')">View Project Activities</a>
                        </li>
                        <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')">View Internship Activities</a>
                        </li>
				...
				<li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu1111">
                        <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')"> Add Placement Event</a>
                        </li>
                        <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')">Modify Placement Event</a>
                        </li>
                        <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')">Delete Placement Event</a>
                        </li>
						<li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')">View Placement Result</a>
                        </li>
						<li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')">View Placement Season</a>
                        </li>
               ...
               <!-- <li>
                ...
                <li>
					...
					<ul class="collapse list-unstyled" id="pageSubmenu11114ddnnr">
                        <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')"   >NAAC Reports </a>
                        </li>
						 <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')" >NBA Reports</a>
                        </li>
						<li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/userdashboard/activity/index.php','User Activity Reports')"  >User Activity Reports</a>
                        </li>
						<li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')" >Student Competency Reports</a>
                        </li>
				...
				<?php if($usersrole == 3   ||  $usersrole == 4 ) { ?>
				   <li>
					...
					<ul class="collapse list-unstyled" id="pageSubmenu11114ddnn">
                        <li>
                            <a href="#"  onclick='redirecturlsstudent1("https://nsms.odinlearning.in/notications/add","Create Notification")'  >Create Notification </a>
                        </li>
						 <li>
                            <a href="#"  onclick='redirecturlsstudent1("https://nsms.odinlearning.in/notications","Manage Notifications")'>Manage Notifications</a>
                        </li>
				...
				<?php } ?>
				 ...
				 <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu11114dd">
                        <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')"  >Create a survey </a>
                        </li>
						 <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')">Manage survey</a>
                        </li>
						 <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')">Create Poll</a>
                        </li>
						 <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')"  >Stop Poll</a>
                        </li>
						 <li>
                            <a href="#" onclick="redirecturlsstudent1('https://nsms.odinlearning.in/users/comingsoon','')"  >View survey or Poll </a>
                        </li>
...
<iframe src="https://nsms.odinlearning.in/userdashboard/iadash/index.php?id=281 " width="100%" height="80%" frameBorder="0">Browser not compatible.</iframe>
		  	 ...
		  	 <?php /*if($usersrole == 4) { ?>
                    <ul class="collapsible collapsible-accordion">
                        ...
                        <li data-toggle="tooltip" data-placement="right"
                            ...
                            <a href="#" class="collapsible-header waves-effect" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/notications", "Student Notification Management")'  ><i class="w-fa fas fa-bell"></i></a>
                        </li>
...
this.blur();    this.focus();  }"> -->
		 ...
		 <?php if($usersrole == 2) { ?>
                        ...
                        <button type="button" class="btn btn-warning" style="float: right;" onclick='openmodalbox2("View Targets ICC", "List of Targets")'><b>Purchases</b></button>
...
<?php 
	...
	<?php if($usersrole == 2  && $finalgeturl == NULL) { ?>
                    <iframe class="d-block w-100" src="https://nsms.odinlearning.in/users/stepperprofile" id="urlforthemainuser" width="380" height="700" frameBorder="0"></iframe>
	...
	<?php } else if($usersrole == 2 && $finalgeturl != NULL) { ?>
					...
					<iframe class="d-block w-100" src="https://nsms.odinlearning.in/userdashboard/landingdash/index.php?id=<?php echo $userid; ?>" id="urlforthemainuser" width="380" height="700" frameBorder="0"></iframe>
	 <?php }  else { ?>
                    <iframe class="d-block w-100" src="https://nsms.odinlearning.in/users/stepperprofile" id="urlforthemainuser" width="380" height="700" frameBorder="0"></iframe>
	...
	<?php $k1++;  } ?>
                ...
                <!--<div class="carousel-item">
              <iframe class="d-block w-100" src="https://nsms.odinlearning.in/img/java_tutorial.pdf" width="380" height="700" frameBorder="0"></iframe>
            </div>-->
            </div>
   ...
   <?php if($usersrole == 2 && $finalgeturltype != NULL) { ?>
	  ...
	  $getfurlff ='https://nsms.odinlearning.in/users/stepperprofile';
...
<?php } ?>
                        ...
                        <div class="row">
							...
							<?php if($getcatn != 'Semester wise' ) { ?>
                                            <!--<button type="button" class="btn btn-default pull-right" onClick="synctoclanederbystudent();" >Sync to Calendar</button>-->
							<?php } ?>
...
<!--<a type="button" class="btn btn-default pull-right" onclick="alertforuser()" href="https://nsms.odinlearning.in/events/synctocalendar/<?php echo $userid; ?>" >Sync to Calendar</a>
                                        --><?php } ?>
        ...
        <div id="diagnosticsinsghts" class="modal fade right" role="dialog">
            <div class="modal-dialog" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <button type="button" class="btn btn-primary" onClick='openindustry()' >
                            Industry <span class="badge badge-danger ml-2"><?php echo $industrycount; ?></span>
                        </button>
                        <button type="button" class="btn btn-primary" onClick='opencompany()' >
                            Company <span class="badge badge-danger ml-2"><?php echo $companycount; ?></span>
                        </button>
                        <button type="button" class="btn btn-primary" onClick='opentargtes()'>
                            Targets <span class="badge badge-danger ml-2"><?php echo $examcount; ?></span>
                        </button>
                        <button type="button" class="btn btn-primary" onClick='openmodalboxtopics()'>
                            Topics <span class="badge badge-danger ml-2"><?php echo $topicscount; ?></span>
                        </button>

                        <button type="button" class="btn btn-default pull-right" onclick="mytargetsuggestionstudentdisplay()">My Target Suggestion </button>
...
<div class="table-responsive">
                    ...
                    <div id="displaytargets" style="display:none" >
                        <div class="modal-body"  >
				  <?php if($getcatn != 'Semester wise' ) { ?>
                            <button type="button" class="btn btn-default pull-right" onclick="targetrecommender()" >Target Selector </button>
                            <br />
                            <br />
<?php }  ?>
...
<div class="table-responsive">
                    ...
                    <div id="addtargets" style="display:none" >
                        <div class="modal-body"  >
                            ...
                            <!--<button type="button" class="btn btn-default pull-right" onclick='redirecturlsstudent("https://nsms.odinlearning.in/users/jobfilters","My Filters")'>My Filters </button>-->
                            ...
                            <div class="card" style="cursor: pointer;
                                ...
                                <div class="card-body" style="padding: 0.25rem !important;">
                                    <div class="media ml-3">
                                        ...
                                        <button type="button" class="btn btn-default pull-right" onclick="mytargetsuggestionstudentdisplay()">Recommended Targets</button>
                                    </div>
                                </div>
...
<div class="table-responsive">
                    ...
                    <?= $this->Form->end(); ?>-->
                            <button type="button" class="btn btn-default pull-right" onclick="finishatargetcomps()">Preview </button>
                        </div>
                    </div>
                    <!--  <!--<div class="modal-footer">
                         <button type="button" class="btn btn-default btn-default-another" data-dismiss="modal">Close</button>
...
<?php } ?>                       
	  ...
	  <?php } ?>
				...
				<?php if($photoname == 'logo_150-150.png') { ?>
                                                    ...
                                                    <img src="https://nsms.odinlearning.in/img/logo_150-150.png" alt="User Photo" class="z-depth-1 mb-3 mx-auto" style="height:150px;width:150px" id="userpicssave">
  ...
  <?= $this->Form->end(); ?>
            ...
            <?= $this->Form->create($user, ['type' => 'file','onsubmit'=>'return validatephoinenum()']); ?>
						 ...
						 <?= $this->Form->control('fname' ,array('label' => false,'class' => 'form-control' ,'id' => 'inputName')); ?>
						   ...
						   <?= $this->Form->control('lname' ,array('label' => false,'class' => 'form-control' ,'id' => 'inputName1')); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="md-form mb-0">
                                                            ...
                                                            <div class="form-check form-check-inline" id="genderlistuserd" style="
                                                                 padding: 11px;">
                                                                <input type="radio" class="form-check-input" id="materialInline1" name="gender" value="Male" <?php echo ($gender== 'Male') ?  "checked" : "" ;  ?> required>
                                                            ...
                                                            <label for="genderid" class="active">Gender <span style="color:red;">*</span></label>
					   ...
					   <?= $this->Form->control('dateofbirth',array('label' => false,'class' => 'form-control datepicker' ,'id' => 'date-picker-example','required'=>'required')); ?>

                                                            <label for="date-picker-example" class="active">Date of Birth <span style="color:red;">*</span></label>
	...
	'required' => 'required'
                                                            ...
                                                            <label for="category11" class="active">Category <span style="color:red;">*</span></label>
	...
	'required' => 'required'
					    ...
					    <?php /* $this->Form->control('nationality',array('label' => false,'class' => 'form-control' ,'id' => 'nationality','required'=>'required')); */?>
                                                            ...
                                                            <label for="nationality" class="active">Nationality <span style="color:red;">*</span></label>
						 ...
						 <?= $this->Form->control('address',array('label' => false,'class' => 'md-textarea form-control','id'=>'addstu','required' => 'required' , 'rows'=>'3')); ?>


                                                            <label for="addstu"  class="active"  style="margin-top: -9px;">Address (Line 1) <span style="color:red;">*</span></label>
                                                        </div>
                                                    </div>
                                                    <!-- First column -->
				 ...
				 $this->Form->control('country', array(
                                                ...
                                                'class' => 'mdb-select md-form'
                                                            ...
                                                            <select class="mdb-select md-form" searchable="Search here.." onchange="leaveChangecountry(this.value)" name="country" id="countrylistdata" required >
...
<?php } ?>
                                        ...
                                        <option value="5">Japan</option>
                                                            ...
                                                            <select class="mdb-select md-form" searchable="Search here.." id="loadcountrystates" name="state" required>
 ...
 <?php } ?>
                                                            ...
                                                            <label for="countrystate" class="active" style="    margin-top: -23px;
                                                                   font-size: 13px;
                                                                   left: 0;">State <span style="color:red;">*</span></label>									 
						 ...
						 <?= $this->Form->control('city',array('type'=>'text','id'=>'citystudent','label' =>false,'class' => 'form-control','required' => 'required')); ?>
                                                            <label for="citystudent" class="active">City <span style="color:red;">*</span></label>
                                                        </div>
                                                    </div>
						 ...
						 <?= $this->Form->control('pincode',array('type'=>'text','id'=>'pincodeforstude','label' =>false,'onkeypress'=>'return isNumber(event)','class' => 'form-control','required' => 'required')); ?>
                                                            <label for="pincodeforstude" class="active">Zip Code <span style="color:red;">*</span></label>
                                                        </div>
                                                    </div>
                                                    <!-- Second column -->
			 ...
			 <?= $this->Form->control('email',array('label' => false,'class' => 'form-control' ,'disabled' => 'disabled')); ?>
                                                            ...
                                                            <label for="form77ep" class="active">Email (Primary) <span style="color:red;">*</span></label>
					  ...
					  <?= $this->Form->control('phonenumber',array('label' => false,'onkeypress'=>'return isNumber(event)','id'=>'phpnenumbeforstude','onInput'=>'checkLength(10,this)','class' => 'form-control','required' => 'required' )); ?>

                                                            <label for="phpnenumbeforstude"  class="active">Phone # (Primary) <span style="color:red;">*</span></label>
...
//	alert(newVal);
 ...
 <!-- Third row -->
  ...
  <tbody>
    <tr>
      <th style="text-align: left;">  <label for="genderid" class="active"> I would like to be notified of jobs that match</label></th>
      <td style="text-align: left;">					  <!-- Material inline 1 -->
<div class="form-check form-check-inline" >
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="question11">Any job that fulfills the basic criteria</label>
    ...
    <tr>
      <th style="text-align: left;"><label for="genderid" class="active"> I would prefer a job</label></th>
      <td style="text-align: left;"><div class="form-check form-check-inline" >
...
<div class="form-check form-check-inline" >
  ...
  <label class="form-check-label" for="question222"> Near my Native place  </label>
    ...
    <tr>
       <th style="text-align: left;"><label for="genderid" class="active">I would like to avail of Government schemes for employment eg. Government apprentice schemes</label></th>
      <td style="text-align: left;">					  <!-- Material inline 1 -->
<div class="form-check form-check-inline" >
...
<div class="form-check form-check-inline" >
  ...
  <label class="form-check-label" for="question33">No </label>
	...
	<tr>
      <th style="text-align: left;"> <label for="genderid" class="active">If I have to pick between a job that provides stability vs high learnability I will pick</label></th>
      <td style="text-align: left;">					  <!-- Material inline 1 -->
<div class="form-check form-check-inline" >
...
<div class="form-check form-check-inline" >
  ...
  <label class="form-check-label" for="question44">Learning company</label>
	...
	<tr>
      <th style="text-align: left;"> <label for="genderid" class="active">If I have to pick between a well-defined environment vs ad-hoc high energy start-up, I will pick</label></th>
      <td style="text-align: left;"><div class="form-check form-check-inline" >
...
<div class="form-check form-check-inline" >
  ...
  <label class="form-check-label" for="question55">A High Energy start-up </label>
	...
	<tr>
       <th style="text-align: left;"> <label for="genderid" class="active">If I have to pick between an established company vs a startup I will pick</label></th>
      <td style="text-align: left;"> 			  <!-- Material inline 1 -->
...
<div class="form-check form-check-inline" >
  ...
  <label class="form-check-label" for="question66">The young startup  </label>
	...
	<tr>
      <th style="text-align: left;"> <label for="genderid" class="active">How important is money in my first Job </label></th>
...
<?php } ?>
 ...
 <?= $this->Form->end(); ?> 
  ...
  <button type="button" class="btn btn-primary" onClick="modalboxes(1)"  id="modalboxes1"   style=" height: 10px;
...
(<span id="getvaluesp2"><?php echo number_format((float)$teamwork * 100, 2, '.', ''); ?></span>%)</label>
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(2)"  id="modalboxes2"   style=" height: 10px;
   ...
   <?php  } else { ?>
      ...
      <button type="button" class="btn btn-primary" onClick="modalboxes(2)"  id="modalboxes2"   style=" height: 10px;display:none;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(3)"  id="modalboxes3"   style=" height: 10px;
   
    line-height: 2px;
    padding-left: 3px;
    padding-right: 3px;">Quiz</button>
   <?php  } else { ?>
     <button type="button" class="btn btn-primary" onClick="modalboxes(3)"  id="modalboxes3"   style=" height: 10px;display:none;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(4)"  id="modalboxes4"  style=" height: 10px;
   ...
   <?php  } else { ?>
     ...
     <button type="button" class="btn btn-primary" onClick="modalboxes(4)"  id="modalboxes4"  style=" height: 10px;display:none;
   ...
   <?php } ?> 
	  ...
	  <button type="button" class="btn btn-primary" onClick="modalboxes(5)"  id="modalboxes5"  style=" height: 10px;
   ...
   <?php  }  else { ?>
   	  ...
   	  <button type="button" class="btn btn-primary" onClick="modalboxes(5)"  id="modalboxes5"  style=" height: 10px;display:none;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(6)"    id="modalboxes6" style=" height: 10px;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(6)"    id="modalboxes6" style=" height: 10px;display:none;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(7)"  id="modalboxes7"   style=" height: 10px;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(8)"  id="modalboxes8"  style=" height: 10px;
  ...
  <div class="col-md-6">
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(11)"  id="modalboxes11"  style=" height: 10px;
 
    line-height: 2px;
    padding-left: 3px;
    padding-right: 3px;">Quiz</button>
   <?php  } else { ?>
      <button type="button" class="btn btn-primary" onClick="modalboxes(11)"  id="modalboxes11"  style=" height: 10px;display:none;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(10)"   id="modalboxes10"  style=" height: 10px;
   ...
   <?php  } else {?>
    ...
    <button type="button" class="btn btn-primary" onClick="modalboxes(10)"   id="modalboxes10"  style=" height: 10px;display:none;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(9)"  id="modalboxes9"  style=" height: 10px;
   ...
   <button type="button" class="btn btn-primary" onClick="modalboxes(12)"   id="modalboxes12"  style=" height: 10px;
...
<button type="button" class="btn btn-primary" onClick="evaluatemypersoanlity()" id="eveabriges" >Evaluate your personality type</button>
		<?php } else { ?>
 <img class="img-fluid" style="height: 105px;" onClick="redirecturlsstudent17545574('https://nsms.odinlearning.in/users/<?php echo $myersbriggs; ?>','<?php echo strtoupper($myersbriggs); ?>')" id="userpicturechange5555" src="https://openodin.odinlearning.in/img/<?php echo $myersbriggs; ?>.png" 
    alt="<?php echo strtoupper($myersbriggs); ?>">

<button type="button" class="btn btn-primary" onClick="evaluatemypersoanlity()" id="eveabriges" style="display:none;" >Evaluate your personality type</button>
		<div id="loadimgss"></div>
		<?php } ?>
 ...
 <button type="button" class="btn btn-primary" onClick="resetallkeys()">Re-attempt Quiz</button>
</div>
						   ...
						   $("#eveabriges").show();
						     $("#userpicturechange5555").hide();
							   $("#dbfskjvKJSFJKAFDFAS").hide();
                                                ...
                                                <h4 class="mb-0 font-weight-bold" <?php if($usersrole == 2) { ?>  style="padding-left: 195px;" <?php } ?> >Profile
				 <?php if($usersrole == 2) { ?>
                                                    <a target="_blank" href="https://nsms.odinlearning.in/users/studentresume"  style="float: right;line-height:9px;margin-top:-4px" id="getStart-content-CLI-jquery" class="btn btn-yellow btn-md flex-fill waves-effect waves-light" target="_blank" alt="PDF button">Curriculum Vitae
                                                        <i class="fas fa-eye ml-2 d-none d-xl-inline-block"></i>
                                                    </a>
				 <?php } ?>
                                                </h4>
					  ...
					  <?php if($photoname == 'logo_150-150.png') { ?>
                                                                            ...
                                                                            <img class="d-flex rounded-circle avatar z-depth-1-half mr-3" id="userpicturechange" src="https://nsms.odinlearning.in/img/logo_150-150.png"  style="height:70px;width:70px"
                                                                                 alt="Avatar">
...
<?php } ?>
  	 ...
  	 <?= $this->Form->control('aboutme',array('label' => false,'class' => 'md-textarea form-control','id'=>'aboutmedata','required' => 'required' ,'pattern'=>'\S+', 'title'=>'This field is required', 'rows'=>'3' , 'maxlength'=>'250')); ?>
                                                                                <span class="waves-input-wrapper waves-effect waves-light" style="float: right;"><input type="submit" value="Update Details" class="btn btn-info btn-rounded"></span>
                                                                            </div>
                                                                        </div>
 ...
 <div class="tab-pane fade" id="bystudentsmodule" style="background-color:white !important;">
		...
		<br />
		 ...
		 <div class="table-responsive">
                                        <table class="table table-bordered table-striped">
											...
											<tr class="odd gradeX">
                                                    <td>Module 1/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("https://nsms.odinlearning.in/razor/prod1.php ","Module 1/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 2/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("https://nsms.odinlearning.in/razor/prod1.php ","Module 2/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 3/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("https://nsms.odinlearning.in/razor/prod1.php ","Module 3/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 4/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("https://nsms.odinlearning.in/razor/prod1.php ","Module 4/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 5/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("https://nsms.odinlearning.in/razor/prod1.php ","Module 5/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 6/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("https://nsms.odinlearning.in/razor/prod1.php ","Module 6/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 7/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("https://nsms.odinlearning.in/razor/prod1.php ","Module 7/8")'  style="background-color:#FD8401" >Buy now</button></td>
                                                    
                                                </tr>
												<tr class="odd gradeX">
                                                    <td>Module 8/8</td>
                                                    <td><button type="submit" class="btn btn-default" onclick='redirecturlsstudent("https://nsms.odinlearning.in/razor/prod1.php ","Module 8/8")'  style="background-color:#FD8401" >Buy now</button></td>
	...
	document.getElementById(b).value = newVal;
												   ...
												   <?= $this->Form->create($user, array('action' => '/adduserstudyhours')) ?>
                                                    <td><div class="input-group number-spinner">
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="dwn" onClick="spinnernumber('down','sunday');return false;"><span class="glyphicon glyphicon-minus"></span></span>
				</span>
				...
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="up" onClick="spinnernumber('up','sunday');return false;"><span class="glyphicon glyphicon-plus"></span></span>
				</span>
			</div></td>
			<td><div class="input-group number-spinner">
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="dwn" onClick="spinnernumber('down','monday');return false;"><span class="glyphicon glyphicon-minus"></span></span>
				</span>
			
				
				<?= $this->Form->control('monday' ,array('type'=>'text','max'=>'24', 'readonly' => 'readonly','label' => '','class' => 'form-control text-center' , 'id'=>'monday')); ?>
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="up" onClick="spinnernumber('up','monday');return false;"><span class="glyphicon glyphicon-plus"></span></span>
				</span>
			</div></td>
			<td><div class="input-group number-spinner">
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="dwn" onClick="spinnernumber('down','tuesday');return false;"><span class="glyphicon glyphicon-minus"></span></span>
				</span>
				
				<?= $this->Form->control('tuesday' ,array('type'=>'text','max'=>'24', 'readonly' => 'readonly', 'label' => '','class' => 'form-control text-center' , 'id'=>'tuesday')); ?>
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="up" onClick="spinnernumber('up','tuesday');return false;"><span class="glyphicon glyphicon-plus"></span></span>
				</span>
			</div></td>
			<td><div class="input-group number-spinner">
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="dwn" onClick="spinnernumber('down','wednesday');return false;"><span class="glyphicon glyphicon-minus"></span></span>
				</span>
				
				<?= $this->Form->control('wednesday' ,array('type'=>'text','max'=>'24',  'readonly' => 'readonly','label' => '','class' => 'form-control text-center' , 'id'=>'wednesday')); ?>
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="up" onClick="spinnernumber('up','wednesday');return false;"><span class="glyphicon glyphicon-plus"></span></span>
				</span>
			</div></td>
			<td><div class="input-group number-spinner">
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="dwn" onClick="spinnernumber('down','thursday');return false;"><span class="glyphicon glyphicon-minus"></span></span>
				</span>
				
					<?= $this->Form->control('thursday' ,array('type'=>'text','max'=>'24', 'readonly' => 'readonly', 'label' => '','class' => 'form-control text-center' , 'id'=>'thursday')); ?>
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="up" onClick="spinnernumber('up','thursday');return false;"><span class="glyphicon glyphicon-plus"></span></span>
				</span>
			</div></td>
			<td><div class="input-group number-spinner">
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="dwn" onClick="spinnernumber('down','friday');return false;"><span class="glyphicon glyphicon-minus"></span></span>
				</span>
			
				<?= $this->Form->control('friday' ,array('type'=>'text','max'=>'24',  'readonly' => 'readonly','label' => '','class' => 'form-control text-center' , 'id'=>'friday')); ?>
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="up" onClick="spinnernumber('up','friday');return false;"><span class="glyphicon glyphicon-plus"></span></span>
				</span>
			</div></td>
			<td><div class="input-group number-spinner">
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="dwn" onClick="spinnernumber('down','saturday');return false;"><span class="glyphicon glyphicon-minus"></span></span>
				</span>
				
					<?= $this->Form->control('saturday' ,array('type'=>'text','max'=>'24', 'readonly' => 'readonly', 'label' => '','class' => 'form-control text-center' , 'id'=>'saturday')); ?>
				<span class="input-group-btn">
					<span class="btn btn-default" data-dir="up" onClick="spinnernumber('up','saturday');return false;" ><span class="glyphicon glyphicon-plus"></span></span>
				</span>
			</div></td>
										...
										<div class="form-group">
																	<button type="submit" class="btn btn-default" style="margin-left: 9px;" >Save</button>
				<?= $this->Form->end(); ?>
...
<div class="table-responsive">
	<table class="table table-striped table-bordered table-hover" >
      ...
      <button class="next-btn btn btn-primary" style="position: relative;margin-top: 12px;left: 90%;">Close</button>
    </div>
  </div>
                        ...
                        <div class="steps1" id="laefvsadfsjk">
                            <div class="step"><span style="margin-left: -28px;
                                ...
                                <div class="step-content four1">
                                    ...
                                    <button class="next-btn btn btn-primary" style="position: relative;margin-top:-23px;left: 90%;">Next</button>
                                </div>
                            </div>
                            <div class="step minimized"><span style="margin-left: -28px;
                                ...
                                <div class="step-content one1">
                                   ...
                                   <!-- <table class="table table-striped table-bordered table-hover" >
                                    ...
                                    <button class="next-btn btn btn-primary" style="position: relative;margin-top: 12px;left: 90%;">Next</button>
                                </div>
                            </div>
                            <div class="step minimized"><span style="margin-left: -28px;
                                                              z-index: 100000000;
...
<div class="table-responsive">
                        ...
                        <!-- <button type="button" class="btn btn-default pull-right" onclick="if (confirm('This action cannot be undone. Are you sure want to proceed?')) finishatargetcompsfinsish(); return false" >Confirm </button>-->

                        <button type="button" class="btn btn-default pull-right" onclick="finishatargetcompsfinsish();
...
<div class="tab-content" id="myTabnewcContent">
  ...
  <iframe  id="" width="100%" height="800" frameBorder="0" class="holds-the-iframe00" src="https://nsms.odinlearning.in/userdashboard/competency/index.php" ></iframe>
            ...
            <div class="modal-dialog" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
					 ...
					 <button type="reset" class="btn btn-default" onclick='onlineclassmodal()'> ADD ONLINE CLASS</button>
                        ...
                        <button type="submit" class="btn btn-default" onclick = 'openmodalboxforadmin("Add Targets", "Add Targets");return false;' >Add Job Test</button>
                     <!--   <button type="reset" class="btn btn-default" onclick = 'addsemadmin("Add Targets", "Add Targets");
                                return false;'> Add Semester Event</button> -->
                     <!--   <button type="reset" class="btn btn-default" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/institutecalendar", "Event Management")'> Event Management</button>-->
						
						<button type="reset" class="btn btn-default" onclick='onlineclassmodalf2f()'> ADD ON CAMPUS CLASS </button>
						
						<button type="reset" class="btn btn-default" onclick='shwoaddeventsnew();return false;'> ADD EVENTS </button>
						<?php  //if ($this->request->getSession()->read('sessionname2') == 3) { ?>
						<button type="reset" class="btn btn-default" onclick='shwoaddeventsnewfilters();return false;'>Filter </button>
						<button type="reset" class="btn btn-default" id="foletrdbuifckf" style="display:none" onclick='calendarviewforadmin("all","all");return false;'>Clear Filter </button>
						
						 <button type="reset" class="btn btn-default" onclick='colorlegndsh()'> EVENT COLOR LEGEND</button>
						<?php //} ?>
...
<div class="tab-content" id="myTabnewssContent">
  ...
  <iframe  id="" width="100%" height="800" frameBorder="0" class="holds-the-iframe00" src="https://nsms.odinlearning.in/userdashboard/index.php" ></iframe>
  
  </div>
  <div class="tab-pane fade" id="profile000" role="tabpanel" aria-labelledby="profile000-tab">
  
  <iframe  id="" width="100%" height="800" frameBorder="0" class="holds-the-iframe00" src="https://nsms.odinlearning.in/userdashboard/activity/index.php" ></iframe>
  </div>
...
<div class="table-responsive">
	...
	'onchange' => 'createslectseme1(this)',
		'style'=>'display: block !important'
				...
				<?= $this->Form->submit('Save', array('class' => 'btn btn-default','id' => 'stdinfosave')); ?>
    ...
    'url' => [
		...
		<?php      echo $this->Form->control('description' , array('rows'=>'3','label'=>'Description:','required' => 'required','class' => 'md-textarea form-control','id'=>'decriptionatreaofinterest1001')); ?>
                        ...
                        <button type="submit" class="btn btn-default" onClick="saveareaofinterets(1)">Add</button>
		...
		<?php      echo $this->Form->control('description' , array('rows'=>'3','label'=>'Description:','required' => 'required','id'=>'decriptionatreaofinterest1002','class' => 'md-textarea form-control')); ?>
                        ...
                        <button type="submit" class="btn btn-default" onClick="saveareaofinterets(2)">Add</button>
		...
		<?php      echo $this->Form->control('description' , array('rows'=>'3','label'=>'Description:','required' => 'required','class' => 'md-textarea form-control','id'=>'decriptionatreaofinterest1003')); ?>
                        ...
                        <button type="submit" class="btn btn-default" onClick="saveareaofinterets(3)">Add</button>
		...
		<?php      echo $this->Form->control('description' , array('rows'=>'3','label'=>'Description:','required' => 'required','class' => 'md-textarea form-control','id'=>'decriptionatreaofinterest1004')); ?>
                        ...
                        <button type="submit" class="btn btn-default" onClick="saveareaofinterets(4)">Add</button>
		...
		<?php      echo $this->Form->control('description' , array('rows'=>'3','label'=>'Description:','required' => 'required','class' => 'md-textarea form-control','id'=>'decriptionatreaofinterest1005')); ?>
                        ...
                        <button type="submit" class="btn btn-default" onClick="saveareaofinterets(5)">Add</button>
		...
		<?php      echo $this->Form->control('description' , array('rows'=>'3','label'=>'Description:','required' => 'required','class' => 'md-textarea form-control','id'=>'decriptionatreaofinterest1006')); ?>
                        ...
                        <button type="submit" class="btn btn-default" onClick="saveareaofinterets(6)">Add</button>
		...
		<?php      echo $this->Form->control('description' , array('rows'=>'3','label'=>'Description:','required' => 'required','class' => 'md-textarea form-control','id'=>'decriptionatreaofinterest1007')); ?>
                        ...
                        <button type="submit" class="btn btn-default" onClick="saveareaofinterets(7)">Add</button>
...
<?php if($usersrole == 2) { ?>
					 ...
					 <button type="button"  style="position: absolute;left: 384px;top: 5px;" class="btn btn-primary" onclick='redirecturlsstudent1("https://nsms.odinlearning.in/userdashboard/scoreanalysis/index.php?id=<?php echo $userid; ?>","Score Analysis")'>Score Analysis</button>

<?php } else { ?>
					 <!--<button type="button"  style="position: absolute;left: 384px;top: 5px;" class="btn btn-primary" onclick='redirectrespectivestudentscore()'>Score Analysis</button>-->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="placementreport" role="tabpanel" aria-labelledby="placementreport-tab">
							 ...
							 <iframe  id="" width="100%" height="800" frameBorder="0" class="holds-the-iframe00" src="https://nsms.odinlearning.in/userdashboard/placement/index.php" ></iframe>
							</div>
							  ...
							  <div class="tab-pane fade" id="placementreport1" role="tabpanel" aria-labelledby="placementreport1-tab">
							   <iframe  id="" width="100%" height="800" frameBorder="0" class="holds-the-iframe00" src="https://nsms.odinlearning.in/userdashboard/activity/index.php" ></iframe>
							    ...
							    <div class="tab-pane fade" id="placementreport2" role="tabpanel" aria-labelledby="placementreport2-tab">
								 <iframe  id="" width="100%" height="800" frameBorder="0" class="holds-the-iframe00" src="https://nsms.odinlearning.in/userdashboard/internship/index.php" ></iframe>
								</div>
								  <div class="tab-pane fade" id="placementreport3" role="tabpanel" aria-labelledby="placementreport3-tab">
								   <iframe  id="" width="100%" height="800" frameBorder="0" class="holds-the-iframe00" src="https://nsms.odinlearning.in/userdashboard/competency/index.php" ></iframe>
								    ...
								    <div class="tab-pane fade" id="placementreport4" role="tabpanel" aria-labelledby="placementreport4-tab">
									 <iframe  id="" width="100%" height="800" frameBorder="0" class="holds-the-iframe00" src="https://nsms.odinlearning.in/userdashboard/demandsupply/index.php" ></iframe>
									</div>
...
<!-- row requires "row-divided" class -->
  <input type="button" class="btn btn-primary" value="Submit" id="but_upload" >
...
">
	...
	<input type="button" class="btn btn-primary" value="Submit" id="but_uploadnew" >
  </div>
                ...
                if(response == 'Submitted successfully.')
                ...
                else
                    {
                          toastr.error(response);
                              ...
                              <button class="btn btn-primary" type="button" disabled id="showloadingaiisgn" style="display:none">
...
.shadow-textarea textarea.form-control {
    padding-left: 0.8rem;
            ...
            <input type="submit" class="btn btn-primary" value="Submit" id="but_upload" >
					...
					<input type="hidden" id="eventlogsuser" value="">
					   ...
					   <?= $this->Form->control('dateofbirth',array('label' => false,'class' => 'form-control datepickernew' ,'id' => 'date-picker-examplenew','required'=>'required')); ?>
                               ...
                               <label for="date-picker-examplenew" class="active">Date <span style="color:red;">*</span></label>                             
													...
													<div class="col-md-4">
													<button type="button" class="btn btn-primary" onclick="filterlogsbydate(1)">Filter</button>
													<button type="button" class="btn btn-primary" id="clearfilterforevents" style="display:none" onclick="filterlogsbydate(2)">Clear Filter</button>
  ...
  <script type="text/javascript">
    function isNumberKey11(txt, evt) {
     ...
     <input class="form-control" type="text" placeholder="Enter score" id="scoreforstudents" onkeypress="return isNumberKey11(this, event);" required>
            ...
            <input type="button" class="btn btn-primary" value="Add comment" id="but_upload1" >

                              
                              <button class="btn btn-primary" type="button" disabled id="showloadingaiisgn1" style="display:none">
  <span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>
  Loading...
</button>
...
<div class="modal fade" id="basicExampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <tr><td id="titleforonlineevent"></td></tr>
    ...
    <tr>
	 ...
	 <tr>
      <td><a class="btn btn-primary" id="joinlinkforadmin" target="_blank">Click here to join</a>
...
$(document).ready(function() {
 ...
 <li>Update all mandatory fields in each section to get started. These details are used to show you the relevant targets (exams or companies you could consider for a career)</li>
      ...
      <button class="next-btn btn btn-primary" style="position: relative;margin-top: 12px;left: 88%;">Next</button>
    </div>
  </div>
  <div class="step minimized"><span style="margin-left: -28px;
    z-index: 100000000;
...
<li>The maximum targets that can be selected are 10. Once you are finished with adding targets to your selection, Preview and save your targets. The Preview stage allows you to go back and change your selection. When you are finally done, hit the save button.</li> 
 ...
 <li>Click on the lesson to start learning. Happy Learning and I wish you success! </li>
      ...
      <button class="next-btn btn btn-primary" style="position: relative;margin-top: 12px;left: 86%;">Next</button>
    </div>
  </div>
    ...
    <div class="step-content six">
       <button class="next-btn btn btn-primary" style="position: relative;margin-top: 26px;left: 88%;">Close</button>
    </div>
  </div>
...
<iframe width="0" height="0" frameborder="0" scrolling="no" vspace="0" hspace="0" marginheight="0" marginwidth="0" src="https://nsms.odinlearning.in/events/synctocalendar/<?php echo $userid; ?>"></iframe>
...
<iframe width="0" height="0" frameborder="0" scrolling="no" vspace="0" hspace="0" marginheight="0" marginwidth="0" src="https://nsms.odinlearning.in/users/synctocalendar"></iframe>
