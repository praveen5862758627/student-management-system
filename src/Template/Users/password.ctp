...
<html lang="en">
  <head>
    ...
    <title>Forgot Password - Odin Connect</title>
  </head>
  <body>
    ...
    <div class="container-fluid" id="ocforgotpass">
      <div class="row" id="oclogVrow">
          ...
          <div class="col-md-7 text-left" id="ocforgocol031">
              ...
              <p>
                  Enter your email id and we will send you the link to reset your password.
	...
	<?php
        ...
        echo $this->Form->input('email', ['class'=>"form-control",'placeholder'=>"E-Mail",'autofocus' => true, 'label' => false, 'required' => true]);
		
		?>
		<br />
		<?php
		echo $this->Form->button('Request reset email',['class'=>"btn"]);
    	echo $this->Form->end();
	?>
