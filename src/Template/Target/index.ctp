 ...
 * @var \App\Model\Entity\Target[]|\Cake\Collection\CollectionInterface $target
 */
  include('cssjs.ctp');
?>
...
<div class="target index large-9 medium-8 columns content">
    <h3><?= __('Target') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('examcode') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $target->has('user') ? $this->Html->link($target->user->fname .' ' .$target->user->lname , ['controller' => 'Users', 'action' => 'view', $target->user->id]) : '' ?></td>
