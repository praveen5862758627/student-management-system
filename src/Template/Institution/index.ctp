 ...
 * @var \App\Model\Entity\Institution[]|\Cake\Collection\CollectionInterface $institution
 */
 include('cssjs.ctp');
?>
...
<div class="institution index large-9 medium-8 columns content">
    <h3><?= __('Institution') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($institution as $institution): ?>
            <tr>
