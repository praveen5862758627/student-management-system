    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
       ...
       <div class="list-group list-group-flush">
        ...
        <a href="/comparea" class="list-group-item  list-group-item-action waves-effect">
        ...
        <a href="/quiz" class="list-group-item  list-group-item-action waves-effect">
		  ...
		  <a href="/example" class="list-group-item active list-group-item-action waves-effect">
...
<div class="example form large-9 medium-8 columns content">
    <?= $this->Form->create($example,array('class'=>'border border-light p-5')) ?>
    <fieldset>
        <legend><?= __('Add Example') ?></legend>
 
		 <?php
            echo $this->Form->control('lesson_id', ['options' => $lesson,'class'=>'form-control mb-4','label'=>'Lesson:','placeholder'=>"Lesson"]);
            echo $this->Form->control('code',array('class'=>'form-control mb-4','label'=>'Code:','placeholder'=>"Code"));
            echo $this->Form->control('mcode',array('class'=>'form-control mb-4','label'=>'URL:','placeholder'=>"URL"));
            echo $this->Form->control('name',array('class'=>'form-control mb-4','label'=>'Name:','placeholder'=>"Name"));
            echo $this->Form->control('level_id', ['options' => $level,'class'=>'form-control mb-4','label'=>'Level:','placeholder'=>"Level"]);
            echo $this->Form->control('author',array('class'=>'form-control mb-4','label'=>'Author:','placeholder'=>"Author"));
			  echo $this->Form->control('studyduration',array('class'=>'form-control mb-4','label'=>'Study Duration:','placeholder'=>"Study Duration"));
            echo $this->Form->control('targettype_id', ['options' => $targettype,'class'=>'form-control mb-4','label'=>'Target Type:','placeholder'=>"Target Type"]);
			 echo $this->Form->control('courseid',array('class'=>'form-control mb-4','label'=>'Couse ID:','placeholder'=>"Course ID"));
        ?>
    </fieldset>
