      ...
      <div class="list-group list-group-flush">
        ...
        <a href="/lesson" class="list-group-item  list-group-item-action waves-effect">
          <i class="fas fa-map mr-3"></i>Lessons</a>
		     <a href="/chapters" class="list-group-item active list-group-item-action waves-effect">
...
?>
    ...
    <?= $this->Form->create($chapter,array('class'=>'border border-light p-5')) ?>
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('lesson_id',array('class'=>'form-control mb-4','label'=>'Lesson:','placeholder'=>"Lesson"));
            echo $this->Form->control('url',array('class'=>'form-control mb-4','label'=>'URL:','placeholder'=>"URL"));
            echo $this->Form->control('chapterorder',array('class'=>'form-control mb-4','label'=>'Order No.:','placeholder'=>"Order"));
        ?>
    </fieldset>
