    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
       ...
       <div class="list-group list-group-flush">
        ...
        <a href="/lesson" class="list-group-item active list-group-item-action waves-effect">
...
<div class="lesson form large-9 medium-8 columns content">
    <?= $this->Form->create($lesson,array('class'=>'border border-light p-5')) ?>
    <fieldset>
        <legend><?= __('Add Lesson') ?></legend>
    
		 <?php
            echo $this->Form->control('topic_id',array('class'=>'form-control mb-4','label'=>'Topic:','placeholder'=>"Topic"));
            ...
            echo $this->Form->control('level_id',array('class'=>'form-control mb-4','label'=>'Level:','placeholder'=>"Level"));
            echo $this->Form->control('targettype_id',array('class'=>'form-control mb-4','label'=>'Target Type:','placeholder'=>"Target Type"));
