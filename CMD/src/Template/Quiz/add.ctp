    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
       ...
       <div class="list-group list-group-flush">
        ...
        <a href="/quiz" class="list-group-item active list-group-item-action waves-effect">
...
<div class="quiz form large-9 medium-8 columns content">
    <?= $this->Form->create($quiz,array('class'=>'border border-light p-5')) ?>
    <fieldset>
        <legend><?= __('Add Quiz') ?></legend>
		  ...
		  <?php
            ...
            echo $this->Form->control('targettype_id', ['options' => $targettype,'class'=>'form-control mb-4','label'=>'Target Type:','placeholder'=>"Target Type"]);
			 echo $this->Form->control('courseid',array('class'=>'form-control mb-4','label'=>'Course ID:','placeholder'=>"Course ID"));
        ?>
    </fieldset>
