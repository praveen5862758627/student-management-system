...
<body class="grey lighten-3">
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        ...
        <a href="/comparea" class="list-group-item  list-group-item-action waves-effect">
		  ...
		  <a href="/topic" class="list-group-item active list-group-item-action waves-effect">
  ...
  <main class="pt-5 mx-lg-5">
    ...
    <h3><?= __('Topic') ?><?= $this->Html->link(__('Add '), ['action' => '../topic/add'],['class'=>'btn btn-primary']) ?></h3>
        ...
        <tbody>
		 <?php foreach ($notications as $notication): ?>
            <tr>
			  ...
			  $comparea_id = $notication['comparea_id']; 
			  
			  ?>
			   <td><?php echo $notication['id']; ?></td>
			    <td><?php echo $this->Custom->compereaname($comparea_id); ?></td>
				...
				<td> <?= $this->Html->link(__('Add '), ['action' => '../lesson/add', $idd],['class'=>'button']) ?></td>
            </tr>
            <?php endforeach; ?>
