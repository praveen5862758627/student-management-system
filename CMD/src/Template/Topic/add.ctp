...
<div class="topic form large-9 medium-8 columns content">
    <?= $this->Form->create($topic,array('class'=>'border border-light p-5')) ?>
    <fieldset>
        <legend><?= __('Add Topic') ?></legend>
     
		  <?php
            echo $this->Form->control('comparea_id',array('class'=>"mdb-select form-control mb-4",'label'=>'Comparea:','placeholder'=>"Comparea"));
            echo $this->Form->control('code',array('class'=>'form-control mb-4','label'=>'Code:','placeholder'=>"Code"));
            echo $this->Form->control('mcode',array('class'=>'form-control mb-4','label'=>'Mcode:','placeholder'=>"Mcode"));
