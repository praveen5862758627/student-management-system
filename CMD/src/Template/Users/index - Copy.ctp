...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('New User'), ['action' => 'add']) ?></li>
		  <li><?= $this->Html->link(__('Comparea'), ['action' => '../Comparea']) ?></li>
		    <li><?= $this->Html->link(__('Example'), ['action' => '../Example']) ?></li>
			
			 <li><?= $this->Html->link(__('Lesson'), ['action' => '../Lesson']) ?></li>
			  <li><?= $this->Html->link(__('Level'), ['action' => '../Level']) ?></li>
			   <li><?= $this->Html->link(__('Questionbank'), ['action' => '../Questionbank']) ?></li>
			    <li><?= $this->Html->link(__('Quiz'), ['action' => '../Quiz']) ?></li>
			   <li><?= $this->Html->link(__('Status'), ['action' => '../Status']) ?></li>
			     <li><?= $this->Html->link(__('Targettype'), ['action' => '../Targettype']) ?></li>
			   <li><?= $this->Html->link(__('Topic'), ['action' => '../Topic']) ?></li>
